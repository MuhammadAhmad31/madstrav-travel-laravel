                ...
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <div class="user-image mb-4 rounded-circle overflow-hidden">
                                    <img src="{{ url('frontend/images/testimonial-1.jpg') }}" alt="User">
                                </div>
                                <h3 class="mb-4">Alberto</h3>
                                <p class="testimonial">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <div class="user-image mb-4 rounded-circle overflow-hidden">
                                    <img src="{{ url('frontend/images/testimonial-2.jpg') }}" alt="User">
                                </div>
                                <h3 class="mb-4">Abu Bakr</h3>
                                <p class="testimonial">
                                    " I loved it when the waves was shaking harder - was scared too "
                                </p>
                            </div>
                            <hr>
                            <p class="trip-to mt-2">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <div class="user-image mb-4 rounded-circle overflow-hidden">
                                    <img src="{{ url('frontend/images/testimonial-3.jpg') }}" alt="User">
                                </div>
